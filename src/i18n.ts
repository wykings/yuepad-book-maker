...
const messages: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    exportAzw3: "导出 AZW3",
    exportEpub: "导出 EPUB",
    exportHint: "AZW3 用于 USB 传书；EPUB 适合 Send to Kindle",
    chapters: "章节",
    ...
    azw3Preparing: "正在转换封面并准备 AZW3…",
    azw3Done:
      "AZW3 已生成 · {size} · 适合通过 USB 传入现代 Kindle",
    azw3Failed: "AZW3 生成失败。",
  ...
  "zh-TW": {
    ...
    exportAzw3: "匯出 AZW3",
    exportEpub: "匯出 EPUB",
    exportHint: "AZW3 適合 USB 傳書；EPUB 適合 Send to Kindle",
    chapters: "章節",
    ...
    azw3Preparing: "正在轉換封面並準備 AZW3…",
    azw3Done: "AZW3 已產生 · {size} · 適合透過 USB 傳入現代 Kindle",
    azw3Failed: "AZW3 產生失敗。",
  ...
  en: {
    ...
    exportAzw3: "Export AZW3",
    exportEpub: "Export EPUB",
    exportHint: "Use AZW3 over USB; use EPUB with Send to Kindle",
    chapters: "Chapters",
    ...
    exportProgress: "{format} generation progress",
    ...
    azw3Preparing: "Converting the cover and preparing AZW3…",
    azw3Done: "AZW3 created · {size} · ready for USB transfer to Kindle",
    azw3Failed: "Could not create AZW3.",
